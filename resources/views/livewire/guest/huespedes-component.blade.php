...
<div class="">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-4 sm:px-6">
        <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden  ">
            ...
            <div class="flex justify-center mt-1 pb-3">
                ...
                <div>
                    <x-button wire:click="openFormNuevoHuesped"
                        ...
                        <x-label class="text-sm" for=""> Agregar Huesped</x-label>
                ...
                <div>
                    <x-button wire:click="openTablaHuespedes"
                        class="inline-flex items-center px-4 py-2
                        hover:bg-gray-700 dark:hover:bg-gray-400
                        ...
                        <x-label class="text-sm" for=""> Revisar Huespedes</x-label>
    ...
    @if ($showFormNuevoHuesped)
        <livewire:guest.form-guest-component> </livewire:guest.form-guest-component>
    @endif


    @if ($showTablaHuespedes)
        <livewire:guest.table-guest-component> </livewire:guest.table-guest-component>
    @endif
