    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4 grid grid-cols-2 gap-2">
            ...
            <div class="col-span-1 sm:col-span-1">
                ...
                <x-input id="extension" type="text" class="mt-1 block w-full" wire:model="state.extension"
            ...
            <div class="col-span-1 sm:col-span-1">
                ...
                <x-input id="departament" type="text" class="mt-1 block w-full" wire:model="state.departament"
